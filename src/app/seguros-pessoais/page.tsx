...
export default function SegurosPessoaisPage() {
  ...
  return (
    <>
      ...
      <section id="momentos" className="py-24 lg:py-32 bg-[#F7F4EF] scroll-mt-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-3xl sm:text-4xl font-black text-[#05191b] mb-4">Momentos que merecem proteção.</h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6">
            {momentos.map((m) => {
              ...
              return (
                <div
                  key={m.label}
                  className="flex flex-col items-center text-center gap-4 p-8 rounded-3xl bg-white border border-[#05191b]/10 hover:border-[#E0A63D]/50 hover:shadow-lg transition-all"
                >
                  <div className="w-14 h-14 rounded-2xl bg-[#05191b]/5 flex items-center justify-center text-[#0b3337]">
                    <Icon className="w-6 h-6" strokeWidth={1.5} />
                  </div>
                  <span className="text-sm font-bold text-[#05191b]">{m.label}</span>
                </div>
              )
            })}
          </div>
      ...
      <section id="solucoes" className="py-24 bg-white scroll-mt-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-3xl sm:text-4xl font-black text-[#05191b] mb-4">Soluções pensadas para o seu dia a dia.</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-[#F7F4EF]/30 rounded-3xl border border-dashed border-[#05191b]/20 flex flex-col items-center justify-center text-center p-10 min-h-[220px]">
              <div className="w-11 h-11 rounded-xl bg-[#05191b]/5 flex items-center justify-center text-[#0b3337] mb-4">
                <Sparkles className="w-5 h-5" strokeWidth={1.5} />
              </div>
              <h3 className="text-lg font-bold text-[#05191b] mb-2">Outras Soluções</h3>
              <p className="text-[#05191b]/60 text-sm leading-relaxed">
      ...
      <section className="py-24 bg-[#F7F4EF] overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16 text-center max-w-2xl mx-auto">
            <h2 className="text-3xl font-black text-[#05191b] mb-4">Como Atuamos</h2>
          </div>
      ...
      <section className="py-24 bg-[#F7F4EF]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-[#05191b]/60 text-base">As dúvidas mais comuns de quem busca proteção pessoal.</p>
          </div>
