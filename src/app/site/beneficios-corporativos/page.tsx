...
export default function SolucoesBeneficiosPage() {
  ...
  return (
    <>
      ...
      <section className="relative bg-[#05191b] overflow-hidden border-b border-[#E0A63D]/20">
        <div className="grid grid-cols-1 lg:grid-cols-12 max-w-[100vw]">
          <div className="lg:col-span-5 px-6 lg:px-16 py-20 lg:py-32 flex flex-col justify-center z-10 relative">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="bg-[#E0A63D] hover:bg-[#c99333] text-[#05191b] font-bold px-8 py-3.5 rounded-xl transition-all shadow-xl text-sm"
              >
          ...
          <div className="lg:col-span-7 relative h-[400px] lg:h-auto">
            ...
            />
            <div className="absolute inset-0 lg:rounded-l-[100px] bg-gradient-to-r from-[#05191b] to-transparent opacity-80 lg:opacity-30"></div>
          </div>
        </div>
      </section>

      {/* BARRA DE INDICADORES */}
      <section className="bg-[#0b3337] border-b border-[#E0A63D]/20 py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <p className="text-3xl lg:text-4xl font-black text-[#E0A63D] mb-1">Sinistralidade</p>
              <p className="text-xs text-[#F7F4EF]/70 uppercase tracking-wider font-medium">Gestão e Controle Ativo</p>
            </div>
            <div>
              <p className="text-3xl lg:text-4xl font-black text-[#E0A63D] mb-1">Redução</p>
              <p className="text-xs text-[#F7F4EF]/70 uppercase tracking-wider font-medium">Otimização de Custos</p>
            </div>
            <div>
              <p className="text-3xl lg:text-4xl font-black text-[#E0A63D] mb-1">Retenção</p>
              <p className="text-xs text-[#F7F4EF]/70 uppercase tracking-wider font-medium">Valorização de Talentos</p>
            </div>
            <div>
              <p className="text-3xl lg:text-4xl font-black text-[#E0A63D] mb-1">Suporte RH</p>
              <p className="text-xs text-[#F7F4EF]/70 uppercase tracking-wider font-medium">Desoneração Operacional</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* 2. INTRODUÇÃO */}
      <section className="py-24 lg:py-32 bg-[#F7F4EF] border-b border-[#05191b]/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="space-y-6">
              <span className="text-[#0b3337] font-bold tracking-widest text-xs uppercase bg-[#0b3337]/5 px-3 py-1 rounded-full border border-[#0b3337]/10">Visão Estratégica</span>
      ...
      {/* 3. ESPECIALIDADES */}
      <section id="especialidades" className="py-24 bg-white border-b border-[#05191b]/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <span className="text-[#0b3337] font-bold tracking-widest text-xs uppercase bg-[#E0A63D]/10 px-3 py-1 rounded-full border border-[#E0A63D]/30">Portfólio de Benefícios</span>
            <h2 className="text-3xl font-black text-[#05191b] mt-4 mb-3">Nossas Soluções</h2>
            <p className="text-[#05191b]/60 text-sm">Opções desenhadas para atender desde pequenas equipes até grandes corporações.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {especialidades.map((item) => (
              <div key={item.id} className="bg-white rounded-3xl border border-[#05191b]/10 overflow-hidden hover:border-[#E0A63D]/50 hover:shadow-xl hover:shadow-[#05191b]/5 transition-all group flex flex-col h-full">
                <div className="h-48 overflow-hidden relative">
                  <img src={item.image} alt={item.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#05191b]/80 to-transparent"></div>
                  <div className="absolute bottom-4 left-4 w-10 h-10 rounded-full bg-white flex items-center justify-center text-[#E0A63D] shadow-lg">
                ...
                <div className="p-8 flex flex-col flex-grow justify-between">
                  ...
                  <button 
                    onClick={handleOpenLeadModal}
                    className="flex items-center gap-2 text-[#E0A63D] text-sm font-bold hover:text-[#0b3337] transition-colors w-max"
                  >
                    Saiba Mais
      ...
      {/* 4. COMO TRABALHAMOS */}
      <section className="py-24 bg-[#F7F4EF] border-b border-[#05191b]/5 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            <span className="text-[#0b3337] font-bold tracking-widest text-xs uppercase bg-[#0b3337]/5 px-3 py-1 rounded-full border border-[#0b3337]/10">Metodologia</span>
            <h2 className="text-3xl font-black text-[#05191b] mt-4 mb-3">Como Trabalhamos</h2>
            <p className="text-[#05191b]/60 text-sm">Um fluxo estruturado para garantir a melhor entrega para o seu RH.</p>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-4 relative z-10">
              {timelineSteps.map((step, idx) => (
                <div key={idx} className="relative pt-2 lg:pt-0">
                  ...
                  <p className="text-xs text-[#05191b]/60 leading-relaxed pr-4">{step.desc}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-20 bg-white border-b border-[#05191b]/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-sm font-bold uppercase tracking-widest text-[#05191b]/40 mb-10">
            Parcerias com as principais operadoras de saúde e seguradoras do mercado
          </h2>
          <div className="flex flex-wrap justify-center items-center gap-10 sm:gap-16 opacity-60 grayscale hover:grayscale-0 transition-all duration-500 font-black text-2xl text-[#05191b]">
            <span>Amil</span>
      ...
      {/* 6. DIFERENCIAIS */}
      <section className="py-24 bg-[#0b3337] border-b border-[#E0A63D]/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            
            <div className="order-2 lg:order-1 grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="bg-[#05191b]/40 border border-[#E0A63D]/20 p-8 rounded-2xl shadow-sm">
                <svg className="w-8 h-8 text-[#E0A63D] mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>
                <h3 className="text-lg font-bold text-[#F7F4EF] mb-2">Análise de Sinistralidade</h3>
                <p className="text-xs text-[#F7F4EF]/60">Monitoramento contínuo dos índices de utilização para prever e mitigar reajustes.</p>
              </div>
              <div className="bg-[#05191b]/40 border border-[#E0A63D]/20 p-8 rounded-2xl shadow-sm">
                <svg className="w-8 h-8 text-[#E0A63D] mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
                <h3 className="text-lg font-bold text-[#F7F4EF] mb-2">Suporte Operacional ao RH</h3>
                <p className="text-xs text-[#F7F4EF]/60">Retiramos o peso operacional do seu departamento de recursos humanos no dia a dia.</p>
              </div>
              <div className="bg-[#05191b]/40 border border-[#E0A63D]/20 p-8 rounded-2xl shadow-sm">
                <svg className="w-8 h-8 text-[#E0A63D] mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                <h3 className="text-lg font-bold text-[#F7F4EF] mb-2">Poder de Negociação</h3>
                <p className="text-xs text-[#F7F4EF]/60">Relacionamento sólido com operadoras para conseguir as melhores taxas e condições.</p>
              </div>
              <div className="bg-[#05191b]/40 border border-[#E0A63D]/20 p-8 rounded-2xl shadow-sm">
                <svg className="w-8 h-8 text-[#E0A63D] mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                <h3 className="text-lg font-bold text-[#F7F4EF] mb-2">Consultoria Preventiva</h3>
                <p className="text-xs text-[#F7F4EF]/60">Programas ativos de saúde e bem-estar para promover qualidade de vida na equipe.</p>
              </div>
            </div>

            <div className="order-1 lg:order-2 relative h-[500px] rounded-3xl overflow-hidden shadow-2xl border border-[#E0A63D]/20">
              <img 
      ...
      <section className="py-24 bg-[#F7F4EF] border-b border-[#05191b]/5">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-[#0b3337] font-bold tracking-widest text-xs uppercase bg-[#0b3337]/5 px-3 py-1 rounded-full border border-[#0b3337]/10">Esclarecimentos</span>
            <h2 className="text-3xl font-black text-[#05191b] mt-4 mb-3">Dúvidas Frequentes</h2>
            <p className="text-[#05191b]/60 text-sm">Respostas para as principais questões de RH sobre gestão de benefícios.</p>
          </div>
          ...
          <div className="space-y-4">
            {faqItems.map((faq, idx) => (
              <div 
                key={idx} 
                className="bg-white rounded-2xl border border-[#05191b]/10 overflow-hidden transition-all shadow-sm"
              >
                <button
                  onClick={() => toggleFaq(idx)}
                  className="w-full px-6 py-5 text-left font-bold text-[#05191b] flex justify-between items-center gap-4 hover:text-[#E0A63D] transition-colors"
                >
                  <span className="text-base">{faq.question}</span>
                  <svg 
                    className={`w-5 h-5 text-[#E0A63D] shrink-0 transition-transform duration-300 ${openFaq === idx ? 'rotate-180' : ''}`} 
                    fill="none" 
                    stroke="currentColor" 
                    viewBox="0 0 24 24"
                  >
                ...
                {openFaq === idx && (
                  <div className="px-6 pb-6 text-[#05191b]/70 text-sm leading-relaxed border-t border-[#05191b]/5 pt-4">
                    {faq.answer}
                  </div>
                )}
              </div>
      ...
      {/* 8. CTA */}
      <section className="relative py-28 bg-[#05191b] overflow-hidden">
        <img 
          src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&q=80&w=1600" 
          alt="Corporativo institucional" 
          className="absolute inset-0 w-full h-full object-cover opacity-10 mix-blend-luminosity"
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#05191b] to-transparent opacity-90"></div>
