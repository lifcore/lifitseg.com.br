...
export default function SobreEConhecimentoPage() {
  ...
  return (
    <>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 max-w-[100vw]">
          <div className="lg:col-span-6 px-6 lg:px-16 py-20 lg:py-32 flex flex-col justify-center z-10 relative">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                href="#contato"
                className="bg-transparent border border-[#F7F4EF]/20 hover:border-[#E0A63D] hover:text-[#E0A63D] text-[#F7F4EF] font-bold px-8 py-3.5 rounded-xl transition-all text-sm text-center"
              >
                Entrar em contato
              </a>
            </div>
      ...
      <section id="quem-somos" className="py-24 lg:py-32 bg-[#F7F4EF] scroll-mt-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="relative h-[450px] rounded-3xl overflow-hidden shadow-2xl border border-[#05191b]/5 group order-2 lg:order-1">
              <img
            ...
            <div className="space-y-6 order-1 lg:order-2">
              <span className="text-[#0b3337] font-bold tracking-widest text-xs uppercase bg-[#0b3337]/5 px-3 py-1 rounded-md">
                Quem Somos
              </span>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-3xl sm:text-4xl font-black text-[#05191b] mb-4">Nossos Valores</h2>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
            {valores.map((v) => {
              ...
              return (
                <div
                  key={v.label}
                  className="flex flex-col items-center text-center gap-4 p-6 rounded-2xl border border-[#05191b]/10 hover:border-[#E0A63D]/40 hover:shadow-md transition-all"
                >
                  <div className="w-12 h-12 rounded-xl bg-[#05191b]/5 flex items-center justify-center text-[#0b3337]">
                    <Icon className="w-5 h-5" strokeWidth={1.5} />
                  </div>
                  <span className="text-xs font-bold text-[#05191b]">{v.label}</span>
                </div>
              )
            })}
          </div>
      ...
      <section id="conhecimento" className="py-24 bg-[#F7F4EF] scroll-mt-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <div className="w-12 h-12 rounded-xl bg-[#0b3337]/5 flex items-center justify-center text-[#0b3337] mx-auto mb-6">
              <Library className="w-5 h-5" strokeWidth={1.5} />
            </div>
            <h2 className="text-3xl sm:text-4xl font-black text-[#05191b] mb-4">Conhecimento que acompanha a evolução do mercado.</h2>
            <p className="text-[#05191b]/60 text-base leading-relaxed">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative h-[400px] rounded-3xl overflow-hidden shadow-2xl border border-[#05191b]/5">
              <img
      ...
      <section id="contato" className="py-24 bg-[#F7F4EF] scroll-mt-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-3xl sm:text-4xl font-black text-[#05191b] mb-4">Fale com a LifitSeg</h2>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                <div className="w-11 h-11 rounded-xl bg-white flex items-center justify-center text-[#0b3337] shadow-sm flex-shrink-0">
                  <MessageCircle className="w-5 h-5" strokeWidth={1.5} />
                </div>
                <div>
                  <p className="text-xs font-bold text-[#05191b]/50 uppercase tracking-wider mb-1">WhatsApp</p>
                  <p className="text-sm font-semibold text-[#05191b]">{siteConfig.contato.whatsappExibicao}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-xs font-bold text-[#05191b]/50 uppercase tracking-wider mb-1">E-mail</p>
                  <p className="text-sm font-semibold text-[#05191b]">{siteConfig.contato.email}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-xs font-bold text-[#05191b]/50 uppercase tracking-wider mb-1">Endereço</p>
                  <p className="text-sm font-semibold text-[#05191b] leading-relaxed">{siteConfig.endereco.completo}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-xs font-bold text-[#05191b]/50 uppercase tracking-wider mb-1">Horário de Atendimento</p>
                  {/* TODO: confirmar horário oficial com Raphael */}
                  <p className="text-sm font-semibold text-[#05191b]">Segunda a sexta, 9h às 18h</p>
                </div>
              </div>
            </div>

            <div className="bg-white rounded-3xl border border-[#05191b]/10 p-8 shadow-sm">
              <ContatoForm />
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-black text-[#05191b] mb-4">Perguntas Frequentes</h2>
          </div>
