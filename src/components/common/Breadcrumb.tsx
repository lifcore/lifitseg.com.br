...
export default function SobreCentroConhecimentoPage() {
  ...
  const breadcrumbItems = [
    ...
    { label: 'Sobre e Centro de Conhecimento', href: null }
  ];

  // Dados dos Valores (Seção 3 - 2x4 cards)
  const values = [
  ...
  return (
    <>
      ...
      {/* SEÇÃO 4 — CENTRO DE CONHECIMENTO (Branco) */}
      <section className="py-24 bg-white border-b border-[#05191b]/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-16">
            <div className="lg:col-span-7">
              ...
              <h2 className="text-3xl sm:text-4xl font-black text-[#05191b] mt-4 mb-4">
                Conteúdo para quem busca compreender melhor o mercado.
              </h2>
            ...
            <div className="lg:col-span-5 relative h-[260px] rounded-2xl overflow-hidden shadow-lg border border-[#05191b]/10">
              <img 
                src="https://images.unsplash.com/photo-1434030216411-0b793f4b4173?auto=format&fit=crop&q=80&w=1000" 
                alt="Pessoa estudando ou analisando indicadores" 
                className="absolute inset-0 w-full h-full object-cover"
              />
            </div>
          </div>
      ...
      {/* SEÇÃO 5 — TRABALHE CONOSCO (Off White) */}
      <section className="py-24 bg-[#F7F4EF] border-b border-[#05191b]/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <h2 className="text-3xl font-black text-[#05191b] leading-tight">
      ...
      <section className="py-24 bg-white border-b border-[#05191b]/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            {/* Formulário de Contato Rápido (Coluna Direita) */}
      ...
      {/* SEÇÃO 8 — CTA (Verde com Fundo Institucional) */}
